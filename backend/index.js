...
app.get('/', (req, res) => {
    res.send([{
        ...
        Examples: {
            ...
            'create new user(doesnt´t work)': `curl -X POST -H "Content-Type:application/json"  http://localhost:4000/users -d "{"name":"ahmed","email":"ahmed@mail.com","address":{"city":"lessebo","street":"saharastreet","zipcode":"8943"}}"`,
